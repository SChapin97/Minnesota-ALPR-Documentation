# Minnesota ALPR Documentation

### Overview
- ALPRs (Automated License Plate Readers) are cameras (and associated software) that are typically stationed in high traffic locations for law enforcement agencies to find vehicles that may be implicated in crimes.
...
### Project goals
- Create a centralized repository for public data on ALPRs in the state of Minnesota.
- Make it easy to find out where ALPRs are in your area and how to contribute unlisted ALPRs when found.
